...
import { ArrowLeft, Star, ShoppingCart, Heart, MapPin, Coffee } from "lucide-react";
          ...
          <div className="bg-white rounded-4xl shadow-xl overflow-hidden">
            ...
            <div className="grid md:grid-cols-2 gap-5">
              ...
              <div className="p-4">
                ...
                <div className="text-3xl font-bold text-amber-800 mb-8">NPR {selectedProduct.price.toFixed(2)}</div>
                
                {/* Quick Info */}
                <div className="grid grid-cols-3 gap-4 mb-8">
                  <div className="text-center p-4 bg-gray-50 rounded-lg">
                    <MapPin size={24} className="mx-auto mb-2 text-amber-800" />
                    <div className="text-sm font-semibold text-gray-700">Origin</div>
                    <div className="text-xs text-gray-600">{selectedProduct.origin}</div>
                  </div>
                  <div className="text-center p-4 bg-gray-50 rounded-lg">
                    <Coffee size={24} className="mx-auto mb-2 text-amber-800" />
                    <div className="text-sm font-semibold text-gray-700">Process</div>
                    <div className="text-xs text-gray-600">{selectedProduct.process}</div>
                  </div>
                  <div className="text-center p-4 bg-gray-50 rounded-lg">
                    <div className="text-lg font-bold text-amber-800 mb-1">{selectedProduct.altitude}</div>
                    <div className="text-sm font-semibold text-gray-700">Altitude</div>
                    <div className="text-xs text-gray-600">{selectedProduct.weight}</div>
                  </div>
                </div>
                
                {/* Tasting Notes */}
                <div className="mb-6">
                  <h3 className="text-lg font-semibold text-gray-800 mb-3">Tasting Notes</h3>
                ...
                {/* Add to Cart Button */}
                <button
                  onClick={() => addToCart(selectedProduct.name, selectedProduct.price)}
                ...
                >
                  {selectedProduct.inStock ? `Add to Cart - NPR ${selectedProduct.price.toFixed(2)}` : 'Out of Stock'}
                </button>
                ...
                {/* Brewing Tips */}
                <div>
                  <h3 className="text-lg font-semibold text-gray-800 mb-3">Brewing Tips</h3>
                  <p className="text-gray-600 text-sm leading-relaxed">
    ...
    >
      <div className="mx-auto px-6 py-12 relative z-10">
        ...
        <div className="flex justify-between items-center border-b-2 border-amber-800 mb-16 pb-4">
          <h2 className="text-4xl font-bold text-amber-800 uppercase tracking-widest">Products</h2>
        </div>
        
        {/* Category Info */}
        <div className="mb-10">
          <h3 className="text-3xl font-bold text-amber-800 mb-2">Signature Bean Collection</h3>
          <p className="text-gray-600 text-lg max-w-3xl">
            Explore our finest selection of whole coffee beans sourced from top regions around the world. 
            Perfectly roasted for flavor, aroma, and depth. Click on any product to see detailed information and brewing tips.
          </p>
        </div>
          ...
          {products.map((product) => (
            ...
            >
              ...
              <div className="p-6 text-center">
                ...
                <div className="text-xl font-bold text-amber-800 mb-4">NPR {product.price.toFixed(2)}</div>
