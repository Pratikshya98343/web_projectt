      ...
      if (data?.data?.access_token) {
        ...
        try {
          ...
          console.error(
            ...
            testError?.response?.data || testError
          );
          setError(
            `Login successful but failed to access admin features: ${
      ...
      <div className="bg-white backdrop-blur-sm rounded-3xl shadow-2xl p-7 w-full max-w-lg relative border border-[#D2B48C] flex flex-col items-center justify-center">
        ...
        <div className="space-y-8 w-full max-w-md">
          ...
          <div className="flex items-center justify-between">
            ...
            <a
              href="#"
              className="text-sm text-[#6F4E37] hover:text-[#5D3A2A] transition-colors"
            >
              Forgot password?
            </a>
          </div>
