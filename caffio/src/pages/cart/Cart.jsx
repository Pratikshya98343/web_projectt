...
const CaffioAddToCart = () => {
  ...
  const espressoImage = "./image/menu1.png";
  const cappuccinoImage = "./image/menu2.png";
  const MochaImage = "./image/menu5.png";
  const YirgacheffeImage = "./image/product1.png";
  const ColombianImage = "./image/product2.png";
  const organicImage = "./image/product3.png";
  ...
  const products = [
    {
      ...
      description:
        "Smooth, well-balanced coffee with caramel sweetness and nutty undertones.",
      price: 28.99,
      image: espressoImage,
    ...
    },
    {
      ...
      description:
        "Intense, smoky flavor with low acidity. For those who love strong coffee.",
      price: 26.99,
      image: MochaImage,
    ...
    },
    {
      ...
      description:
        "Bright, floral notes with high acidity. Perfect for pour-over brewing.",
      price: 22.99,
    ...
    },
    {
      ...
      description:
        "Naturally sweet with honey-like flavors and tropical fruit notes.",
      price: 32.99,
    ...
    },
    {
      ...
      description:
        "Sustainably sourced, organic certified beans with earthy, complex flavors.",
      price: 29.99,
      image: organicImage,
    ...
    <div className="bg-white/10 backdrop-blur-lg rounded-2xl p-6 border border-white/20 hover:border-amber-400/50 transition-all duration-300 hover:transform hover:-translate-y-2 hover:shadow-2xl group relative overflow-hidden">
      ...
      <div className="flex items-center gap-4 mb-6">
        ...
        <button
          ...
          className="w-10 h-10 bg-white hover:bg-gray-200 rounded-full flex items-center justify-center font-bold transition-all duration-200 hover:scale-110"
        >
                  {/* Change here: Use inline style for color */}
                  <Minus className="w-4 h-4" style={{ color: "black" }} />     {" "}
        </button>
             {" "}
        <span className="text-xl font-bold text-black min-w-8 text-center">
  ...
  return (
    <div className="w-screen bg-gradient-to-br from-amber-900 via-orange-900 to-red-900 text-white relative">
      ...
      >
        ...
        ></div>
        <div
          className={`absolute right-0 top-0 h-full w-full max-w-md bg-gradient-to-b from-amber-900 to-orange-900 shadow-2xl transform transition-transform duration-300 ${
            ...
            {cart.length > 0 && (
              <div className="pt-6 border-t border-white/20">
                ...
                <button
                  onClick={() => {
                    alert(
                      "Proceeding to checkout... Thank you for choosing Caffio!"
                    );
                    setCart([]);
                    setIsCartOpen(false);
                  }}
      ...
      {/* Success Animation */}
      <div
        className={`fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-green-600/90 backdrop-blur-sm text-white px-8 py-4 rounded-2xl font-bold text-lg z-50 transition-all duration-300 ${
          showSuccess
