...
const menuItems = [
    {
        ...
        category: "Espresso",
        description: "Rich and bold single shot espresso made from our premium blend of Ethiopian and Colombian beans.",
    ...
    },
   {
        ...
        description: "Perfect balance of espresso, steamed milk, and velvety foam topped with a delicate art design.",
        ingredients: ["Espresso shot", "Steamed milk", "Milk foam", "Optional: cocoa powder"],
    ...
    },
    {
        ...
        description: "Creamy latte infused with premium vanilla syrup and topped with smooth steamed milk.",
        ingredients: ["Espresso shot", "Steamed milk", "Vanilla syrup", "Milk foam"],
    ...
    },
    {
        ...
        description: "Classic Americano with perfect balance of espresso and hot water for a smooth, energizing drink.",
    ...
    },
    {
        ...
        category: "Specialty",
        description: "Rich chocolate mocha with premium dark chocolate and perfectly balanced espresso.",
        ingredients: ["Espresso shot", "Dark chocolate syrup", "Steamed milk", "Whipped cream", "Cocoa powder"],
    ...
    },
    {
        ...
        category: "Specialty",
        description: "Layered macchiato with vanilla steamed milk, espresso, and rich caramel drizzle.",
        ingredients: ["Espresso shot", "Vanilla syrup", "Steamed milk", "Caramel sauce"],
        brewTime: "4-5 minutes",
        caffeine: "Medium",
        temperature: "Hot",
        rating: 4.7,
    ...
    },
    {
        ...
        description: "Smooth cold brew coffee steeped for 12 hours, perfect for hot summer days.",
    ...
    },
    {
        ...
        category: "Frozen",
        description: "Blended iced coffee with milk, ice, and topped with whipped cream for the ultimate treat.",
        ingredients: ["Espresso shot", "Milk", "Ice", "Sugar syrup", "Whipped cream"],
        brewTime: "3-4 minutes",
        caffeine: "Medium",
        temperature: "Frozen",
        rating: 4.8,
    ...
    },
    {
        ...
        description: "Authentic Turkish coffee prepared the traditional way with finely ground beans and served with delight.",
        ingredients: ["Finely ground coffee", "Water", "Sugar (optional)", "Turkish delight"],
    ...
    },
    {
        ...
        category: "Dessert",
        description: "Italian dessert combining hot espresso poured over premium vanilla ice cream.",
        ingredients: ["Hot espresso shot", "Premium vanilla ice cream", "Optional: amaretto"],
        brewTime: "2-3 minutes",
        caffeine: "Medium",
    ...
    },
    {
        ...
        description: "Our signature dark roast blend with rich, bold flavors and smoky undertones.",
    ...
    },
    {
        ...
        description: "Rare Ethiopian single origin with floral notes, bright acidity, and complex flavor profile.",
                    ...
                    <div className="bg-white rounded-4xl shadow-xl overflow-hidden">
                        ...
                        <div className="grid md:grid-cols-2 gap-5">
                            ...
                            <div className="p-4">
                                ...
                                <h1 className="text-3xl font-bold text-[#333] mb-4">{selectedItem.name}</h1>
                                <p className="text-gray-600 text-lg mb-6">{selectedItem.description}</p>
                                <div className="text-3xl font-bold text-[#8B4513] mb-8">NPR {selectedItem.price.toFixed(2)}</div>
                                {/* Quick Info */}
                                <div className="grid grid-cols-3 gap-4 mb-8">
                                    <div className="text-center p-4 bg-gray-50 rounded-lg">
                                        ...
                                        <div className="text-sm font-semibold text-gray-700">Brew Time</div>
                                        <div className="text-xs text-gray-600">{selectedItem.brewTime}</div>
                                    </div>
                                    <div className="text-center p-4 bg-gray-50 rounded-lg">
                                        <svg
                                            xmlns="http://www.w3.org/2000/svg"
                                        ...
                                        <div className="text-sm font-semibold text-gray-700">Caffeine</div>
                                        <div className="text-xs text-gray-600">{selectedItem.caffeine}</div>
                                    </div>
                                    <div className="text-center p-4 bg-gray-50 rounded-lg">
                                        <svg
                                            xmlns="http://www.w3.org/2000/svg"
                                        ...
                                        <div className="text-sm font-semibold text-gray-700">Temp</div>
                                        <div className="text-xs text-gray-600">{selectedItem.temperature}</div>
                                    </div>
                                </div>
                                {/* Ingredients */}
                                <div className="mb-6">
                                ...
                                {/* Nutritional Info */}
                                <div className="mb-6">
                                    <h3 className="text-lg font-semibold text-[#333] mb-3">Nutritional Information</h3>
                                    <div className="grid grid-cols-4 gap-4 text-center">
                                        <div className="bg-gray-50 p-3 rounded-lg">
                                            <div className="text-lg font-bold text-[#8B4513]">{selectedItem.nutritionalInfo.calories}</div>
                                            <div className="text-xs text-gray-600">Calories</div>
                                        </div>
                                        <div className="bg-gray-50 p-3 rounded-lg">
                                            <div className="text-lg font-bold text-[#8B4513]">{selectedItem.nutritionalInfo.protein}</div>
                                            <div className="text-xs text-gray-600">Protein</div>
                                        </div>
                                        <div className="bg-gray-50 p-3 rounded-lg">
                                            <div className="text-lg font-bold text-[#8B4513]">{selectedItem.nutritionalInfo.carbs}</div>
                                            <div className="text-xs text-gray-600">Carbs</div>
                                        </div>
                                        <div className="bg-gray-50 p-3 rounded-lg">
                                            <div className="text-lg font-bold text-[#8B4513]">{selectedItem.nutritionalInfo.fat}</div>
                                ...
                                {/* Add to Cart Button */}
                                <button
                                    onClick={() => addToCart(selectedItem.name, selectedItem.price)}
                                ...
                                {/* Preparation Steps */}
                                <div>
                                    <h3 className="text-lg font-semibold text-[#333] mb-3">Preparation Steps</h3>
            ...
            <div className="mx-auto px-6 py-12 relative z-10">
                ...
                <div className="mb-10">
                    ...
                    <p className="text-gray-600 text-lg max-w-3xl">
                        Discover our premium coffee selection, carefully crafted by our master baristas. Each blend tells a unique story of flavor, aroma, and passion. Click on any item to see detailed preparation methods and ingredients.
                    </p>
                </div>
                {/* Menu Items */}
                    ...
                    {menuItems.map((item) => (
                        ...
                        >
                            ...
                            <div className="p-6 text-center">
                                <h3 className="text-lg font-semibold text-[#333] mb-2 line-clamp-2">{item.name}</h3>
